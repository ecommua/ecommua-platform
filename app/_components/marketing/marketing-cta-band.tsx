  ...
  return (
    <section className="relative isolate overflow-hidden">
      <Container size="xl" className="py-20">
        <div className="relative overflow-hidden rounded-3xl bg-bg px-8 py-16 sm:px-16 sm:py-20 ring-1 ring-bg-elevated shadow-lift">
          {/* Glow blobs */}
          <div
            aria-hidden
          ...
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <div className="mt-9 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                ...
                className="group inline-flex h-12 items-center gap-2 rounded-xl bg-white text-fg hover:bg-bg-muted px-7 text-[15px] font-semibold shadow-lift transition-all hover:-translate-y-0.5"
              >
